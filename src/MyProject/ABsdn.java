...
import org.cloudbus.cloudsim.sdn.example.topogenerators.VirtualTopologyGenerator;
...
public class ABsdn {
    ...
    //protected static String physicalTopologyFile = "energy-physical.json";    
    //protected static String deploymentFile = "energy-virtual.json";    
    //protected static String[] workload_files = {"energy-workload.csv"};
    protected static String physicalTopologyFile = "physical.test.json";
    protected static String deploymentFile = "virtual.test.json";
    protected static String[] workload_files = {"workload.csv"};
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        try {
            PhysicalTopologyGenerator.startTest();
            VirtualTopologyGenerator.main(args);
        } catch (URISyntaxException ex) {
            Logger.getLogger(ABsdn.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        Config.Client_Table = MyProject.ReadWriteExcelFile.ReadFromExcel("Network_access.xls", 0);
        Config.Server_Table = MyProject.ReadWriteExcelFile.ReadFromExcel("Network_access.xls", 1);

        System.out.println(Config.Client_Table);

        System.out.println(Config.Server_Table);
        ...
        try {
            // Initialize
            int num_user = Config.user; // number of cloud users
            ...
            switch (vmAllocPolicy) {
                ...
                case MFF:
                    ...
                    PhysicalTopologyParser.loadPhysicalTopologySingleDC(
                            physicalTopologyFile, nos, hsFac);
...
//				break;
    ...
    public static void submitGroupWorkloads(SDNBroker broker,
            int workloadsNum, int groupSeperateNum,
