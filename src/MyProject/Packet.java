...
public class Packet {
    ...
    private Request payload; // User identify. Access Control 
    private String data; // 
    ...
    public Packet(int origin, int destination, long size, int flowId,
            Request payload, Packet encapsulatedPkt) {
