...
public class VirtualTopologyGenerator {
	...
	{
		final int groupNum = MyProject.Config.VM_group_Count;
	...
	public void addWorkload(String linkname, VMSpec source, VMSpec dest) {
		DummyWorkloadSpec wl = new DummyWorkloadSpec(source.starttime, source.name,
                        dest.name, linkname);
		...
		*/
		...
		for(DummyWorkloadSpec wl:this.dummyWorkload) {
			System.out.println(wl);
                ...
                System.out.println(jsonFileName + " file is created!");
	}
}
